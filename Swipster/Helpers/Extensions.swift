...
extension UIButton {
    ...
    func underline() {
        ...
        attributedString.addAttribute(NSAttributedString.Key.underlineStyle, value: NSUnderlineStyle.single.rawValue, range: NSRange(location: 0, length: (titleLabel?.text!.count)!))
